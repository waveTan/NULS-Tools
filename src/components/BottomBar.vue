  ...
  <el-row class="bottom cb">
    <el-row class="pc">
      <el-row class="w1200 font12 info">
        <el-col :span="22">
          <!-- <div>{{$t('public.developer')}}: <span class="click" @click="toUrl('dream','',0)">wave</span></div>-->
          <div>{{$t('public.developer')}}: <span class="click"
                                                 @click="toUrl('https://www.linkedin.com/in/wave98688/','',1)">wave</span>
          </div>
